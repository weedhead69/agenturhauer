...
<div id="wrapper">
        ...
        <div id="darkbox">
        	<ul>
	           <!-- <li><a href="ueber-uns.php">&Uuml;ber uns</a></li>-->
        		<li><a href="gemeinsamer-weg.php" class="active">Unser gemeinsamer Weg</a></li>
                <li><a href="ueber-uns-gernot.php" >Gernot Hauer</a></li>
				<li><a href="ueber-uns-tatjana.php">Tatjana Gr&ouml;tzl</a></li>
        <li><a href="ueber-uns-karin.php">Karin Gafgo </a></li>
   ...
   <br /><br /><br />
   		<p class="txt_headline">Unser gemeinsamer Weg:</p>

		<p class="txt">
            Wir wollen, dass sich die Menschen sicher fühlen.
            Sicherheit ist ein menschliches Urbedürfnis. 
            Wenn wir uns sicher fühlen, leben wir entspannter, verwirklichen unsere Träume und wagen Neues.
            </p>
            <p class="txt_headline">Ihre Existenz absichern</p>
            <p class="txt">
            Finanzielle Existenzsicherung bei Haftpflicht Ansprüchen, Rechtsstreitigkeiten, Unfall oder Krankheit.
            Best möglicher Versicherungsschutz für Ihr Eigenheim oder Ihre Wohnung.
            </p>
            
            <p class="txt_headline">Ihr Vermögen aufbauen</p>
            <p class="txt">
            Mit uns haben Sie den Durchblick bei allen Lebensversicherungen und
            Fondsgebundenen Veranlagungen.
            </p>  
            
             <p class="link_rechts_impressum"><a href="gemeinsamer-weg2.php">&nbsp;weiter <img src="img/icon_arrow_weiter.gif" /> </a></p>
    </div>
