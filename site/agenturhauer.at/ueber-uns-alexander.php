...
<div id="wrapper">
   ...
   <div id="box1">
        ...
        <div id="darkbox">
        	<ul>
                ...
                <li><a href="ueber-uns-alexander.php" class="active">Alexander Svacina</a></li>
   ...
   <div id="box2_leistung">
   		<div id="left_mitte">
            <p class="txt_headline">Alexander Svacina</p>
            ...
            <p class="txt_personen">
              <strong>Sicherheit bedeutet für mich:</strong> <br />
                ...
                <br /><br />
               	...
               	-  11 Jahre Branchenerfahrung <br />
				&nbsp;&nbsp;Seit 2020 im Team der Versicherungsagentur Gernot Hauer

               
            </p>
          </div>  
            <div id="right_gernot">
	            <img src="img/alexander-svacina.jpg" alt="Alexander Svacina"/>
            </div>
    </div>
