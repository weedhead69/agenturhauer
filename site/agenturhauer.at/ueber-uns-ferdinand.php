...
<div id="wrapper">
   ...
   <div id="box1">
        ...
        <div id="darkbox">
        	<ul>
                ...
                <li><a href="ueber-uns-ferdinand.php" class="active">Ferdinand Hauer</a></li>
            </ul>
        </div>
   </div>
   ...
   <div id="box2_leistung">
   		<div id="left_mitte">
            <p class="txt_headline">Ferdinand Hauer</p>
            <span style="font-weight: normal; color: #a6aaad; text-transform: none; margin-left:30px;">Konsulent in Pension</span>
            <p class="txt_personen">
              <strong>Sicherheit bedeutet für mich:</strong> <br />
                Familie und gute Freunde, Partner auf die man sich verlassen kann.
                <br /><br />
                
                Über 40 Jahre Berufserfahrung<br />
				Bis zur Pensionierung 2011 Leiter der Basler Versicherung Krems
            </p>
          </div>  
            <div id="right">
	            <img src="img/hauer_f.jpg" alt="Ferdinand Hauer"/>
            </div>
    </div>
