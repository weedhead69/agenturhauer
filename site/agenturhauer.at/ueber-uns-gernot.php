...
<div id="wrapper">
   ...
   <div id="box1">
        ...
        <div id="darkbox">
            ...
            <li><a href="gemeinsamer-weg.php" >Unser gemeinsamer Weg</a></li>
                <li><a href="ueber-uns-gernot.php" class="active">Gernot Hauer</a></li>
   ...
   <div id="box2_leistung">
		<div id="left">
            <p class="txt_headline">Gernot Hauer</p>
            <span style="font-weight: normal; color: #a6aaad; text-transform: none; margin-left:30px;">Firmengründer und Inhaber der Versicherungsagentur</span>
            <p class="txt_personen">
              <strong>Sicherheit bedeutet für mich:</strong> <br />
                Die Gegenwart genießen zu können, ohne sich Sorgen über die Zukunft machen zu müssen.
                <br /><br />
                
                - Akademischer Versicherungskaufmann<br />
                &nbsp;&nbsp;Wirtschafts- Universität Wien<br />
               
                - Akademischer Finanzdienstleister<br />
                &nbsp;&nbsp;FAF  (Fachakademie für Finanzdienstleister)<br />
               
                - Maklerprüfung<br />
                
                - Spezialist für betriebliche Altersvorsorge (EU Zertifikat) <br />
                <br />
                Die enge Partnerschaft mit der Basler Versicherung schlägt sich schon seit über 10 Jahren in Topergebnissen und höchster Kundenzufriedenheit nieder:<br />
                <br />
                Seit 1999 - 11 x  Gold <br />
                (beste Vertriebspartner der Basler Versicherung Österreich)
    
            </p>
           </div>  
            <div id="right_gernot">
	            <img src="img/gernot-hauer.png" alt="Gernot Hauer"/>
            </div>
    </div>
