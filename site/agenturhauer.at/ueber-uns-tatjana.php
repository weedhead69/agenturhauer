...
<div id="wrapper">
   ...
   <div id="box1">
        ...
        <div id="darkbox">
            ...
            <li><a href="gemeinsamer-weg.php" >Unser gemeinsamer Weg</a></li>
                ...
                <li><a href="ueber-uns-tatjana.php"  class="active">Tatjana Harauer</a></li>
   ...
   <div id="box2_leistung">
   		<div id="left_mitte">
            <p class="txt_headline">Tatjana Harauer</p>
            ...
            <p class="txt_personen">
              <strong>Sicherheit bedeutet für mich:</strong> <br />
                Ein stabiles Umfeld zu haben, in dem man jede Krise meistern kann.
                <br /><br />
                
               	- Staatlich geprüfte Versicherungskauffrau<br />
				&nbsp;&nbsp;Seit 2005 im Team der Versicherungsagentur Gernot Hauer

               
            </p>
          </div>  
            <div id="right_gernot">
	            <img src="img/tatjana.jpg" alt="Tatjana Hauer"/>
            </div>
    </div>
